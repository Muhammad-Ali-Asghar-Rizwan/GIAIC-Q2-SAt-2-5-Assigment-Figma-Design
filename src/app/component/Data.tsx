    ...
    <div>
      ...
      <div className="h-[1370.76px] bg-no-repeat" style={{ backgroundImage: "url(/images/back.png)" }}>
        ...
        <div className="flex items-center justify-between px-10">
          <div className="mt-24">
            <h1 style={{ backgroundImage: "url(/images/underline.png)" }} className="text-[60px] font-bold bg-botto bg-bottom bg-no-repeat">
              100% your data
            </h1>
            <p className="w-[30rem]">
            ...
            <button className="flex items-center justify-center gap-3 w-[192px] h-[63px] bg-[#4F9CF9] rounded-lg md:mt-14 text-white hover:bg-[#2989ff]">
