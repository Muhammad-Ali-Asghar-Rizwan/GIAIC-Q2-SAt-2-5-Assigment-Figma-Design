...
const Plan = () => {
  return (
    <div>
      ...
      <div className='h-[80rem] mt-44 md:mt-52'>
        <div className='flex flex-col  items-center justify-center '>
        <h1 className='text-[40px] md:text-[72px] font-bold bg-no-repeat bg-bottom' style={{backgroundImage:"url(/images/underline.png)"} }>Choose Your Plan</h1>
        <p className='text-[18px] w-[20rem] md:w-[40rem] text-center mt-5' >Whether you want to get organized, keep your personal life on track, or boost workplace productivity, Evernote has the right plan for you.</p>
        </div>
        <div className='flex flex-col lg:flex-row  md:mb-2 items-center justify-between gap-8 px-10 mt-24' >
            <div className='h-[550px] w-[300px]  md:h-[630px] md:w-[654px]  border-2 border-solid border-[#FFE492] rounded-lg  hover:bg-[#043873] hover:h-[550px] hover:w-[320px]  md:hover:h-[670px] md:hover:w-[700px] hover:text-white hover:transition-all hover:duration-300'>
                ...
                <p className='flex gap-3 md:mt-5'><FiCheckCircle  className='mt-1'/>   10 GB monthly upload  </p>
